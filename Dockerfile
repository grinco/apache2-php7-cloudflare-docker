...
RUN apt-get update
RUN apt-get -y install libapache2-mod-php7.0 php7.0-memcache php7.0-memcached php7.0-readline php7.0-recode php7.0-xsl php7.0-mcrypt php7.0-curl php7.0-mysql php7.0-bcmath php7.0-zip php7.0-mbstring
